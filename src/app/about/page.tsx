      ...
      <main className="max-w-6xl mx-auto px-6 py-20">
        ...
        <section className="mt-10 text-lg leading-relaxed text-black space-y-4 max-w-3xl">
          <p className="text-lg mb-6">
            <strong>3F</strong> empowers early-stage entrepreneurs with{" "}
            <strong>fast</strong>, <strong>simple</strong>, and{" "}
            <strong>transparent</strong> processes to secure and manage P2P
            loans.
          </p>

          <p className="text-lg mb-6">
            Bring your ideas to life with our <strong>all-in-one</strong> tool
            that facilitates fundraising from <strong>Family & Friends</strong>,
            simplifying every step and fostering a supportive community.
          </p>

          <ul className="text-left text-lg space-y-3 mt-8 list-disc list-inside">
            <li>
              Information is shared in a <strong>transparent</strong> way with
              everyone.
            </li>
            <li>
              Contracts are <strong>signed, validated</strong>, and securely
              stored on the platform.
            </li>
            <li>
              Payments are <strong>quick</strong> and <strong>easy</strong>.
            </li>
            <li>
              No more Excel sheets, Word documents, banking apps, or calendar
              alerts!
            </li>
          </ul>
        </section>
        ...
        <section className="grid md:grid-cols-2 gap-8 mt-20">
          ...
          <div className="text-center">
            <h3 className="text-[#E68600] font-semibold text-xl mb-4">
              Meet the team
            </h3>
