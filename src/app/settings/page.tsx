  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white py-10 px-6">
        <h1 className="text-4xl font-bold text-[#B97B00] text-center mb-10">
          Settings
        </h1>

        {/* Tabs */}
        <div className="flex justify-center items-center gap-4 mb-6">
          <button className="bg-[#FFEFD4] text-[#B97B00] px-4 py-2 rounded shadow">
            Account
          </button>
          <button className="bg-white text-[#B97B00] px-4 py-2 border border-[#B97B00] rounded">
            Notifications
          </button>
        ...
        <div className="max-w-md mx-auto space-y-6">
          <div className="flex justify-between items-center border-b pb-1">
            ...
            <button className="px-4 py-1 text-sm rounded bg-gray-200">
              Edit
            </button>
          </div>
          ...
          <p className="text-xs text-gray-500 mt-2">
            Deleting your account will remove all your activities and campaigns,
            and you may not be able to recover.
          </p>
