...
import { createCampaignQuestions } from "@/lib/data/create-campaign-questions";
        ...
        <>
          {step.title && (
            <div className="flex items-center justify-center mb-4 gap-2">
              <h2 className="text-xl font-semibold text-orange-500 ">{step.title}</h2>
              {step.hasTip && (
                <button
                  type="button"
              ...
              {showTip && tips[step.tipName as keyof typeof tips] && step.hasTip && (
                <div className="absolute z-10 bg-orange-500 border-2 border-orange-700 shadow-lg rounded-lg p-4 lg:pr-5 lg:pt-5 text-left text-sm max-w-md m-2 top-1/2 -translate-y-1/2 lg:left-1/2 lg:-translate-x-1/2">
                  <button
                  ...
                  <p className="text-white mt-2">{tips[step.tipName as keyof typeof tips]}</p>
                </div>
              )}
            </div>
          )}
